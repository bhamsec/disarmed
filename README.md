...
- `disarmed.c`: The DisARMed attack implementation. It contains both an implementation of the Linux kernel attack and the TrustZone attack for the NXP LS1046ARDB platform. Additionally contained is root-only debugging code to assist in development, which is excluded by default.
